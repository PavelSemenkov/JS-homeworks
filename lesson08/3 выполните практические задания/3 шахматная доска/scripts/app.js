let app = {
    ...
    insertPawns() {
        ...
        for (let i = 0; i < whitePawnsRow.length; i++) {
            ...
            // Вставляет черную пешку непонятно почему, передается цвет правильно.
        }
    ...
    insertColsChars() {
        ...
        // Непонятно почему вместо полученной строки с tr и td он вставляет пустой tr, хотя в отладчике я вижу как создается нужная строка.
